...
public class android_product_page_verification_men_category {
	
	private static Logger Log = Logger.getLogger(android_product_page_verification_men_category.class.getName());
