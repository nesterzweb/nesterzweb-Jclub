...
public class android_product_page_verification_lifestyle_category {
	
	private static Logger Log = Logger.getLogger(android_product_page_verification_lifestyle_category.class.getName());
	...
	public void productverificationforandroid() throws IOException, InterruptedException {
		...
		adc.product_attribute_verifiction("Men");
	}
}
