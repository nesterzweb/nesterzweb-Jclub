...
public class android_product_page_verification_women_category {
	
	private static Logger Log = Logger.getLogger(android_product_page_verification_women_category.class.getName());
	...
	public void product_attribute_verifiction() throws IOException, InterruptedException{
		...
		Log.info("=====================================================================");
		Log.info("Numbers of Products in women category="+products.size());
		Log.info("=====================================================================");
		
		Reporter.log("=====================================================================");
		Reporter.log("Numbers of Products in women category : ="+products.size());
		Reporter.log("=====================================================================");
