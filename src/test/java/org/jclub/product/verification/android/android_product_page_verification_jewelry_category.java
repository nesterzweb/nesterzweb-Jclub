...
public class android_product_page_verification_jewelry_category {
	
	private static Logger Log = Logger.getLogger(android_product_page_verification_jewelry_category.class.getName());
	...
	public void productverificationforandroid() throws IOException, InterruptedException {
		...
		adc.product_attribute_verifiction("Jewelry");
	}
}
