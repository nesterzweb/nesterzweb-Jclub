...
public class iphone_product_page_verification_home_category {
		
	private static Logger Log = Logger.getLogger(iphone_product_page_verification_home_category.class.getName());
