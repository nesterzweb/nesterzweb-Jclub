...
public class iphone_product_page_verification_electronics_category {
	
	private static Logger Log = Logger.getLogger(iphone_product_page_verification_electronics_category.class.getName());
	...
	ios.click_on_category("Electronics");
	...
	ios.product_attribute_verifiction("Electronics");
}
