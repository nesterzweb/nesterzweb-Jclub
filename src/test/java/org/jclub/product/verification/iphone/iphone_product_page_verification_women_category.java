...
public class iphone_product_page_verification_women_category {
	


	private static Logger Log = Logger.getLogger(iphone_product_page_verification_women_category.class.getName());
