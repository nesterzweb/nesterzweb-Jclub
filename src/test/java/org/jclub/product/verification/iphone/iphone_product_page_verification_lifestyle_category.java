...
public class iphone_product_page_verification_lifestyle_category {
	
	private static Logger Log = Logger.getLogger(iphone_product_page_verification_lifestyle_category.class.getName());
...
public void product_attribute_verifiction() throws IOException, InterruptedException{
	...
	Log.info("=====================================================================");
	Log.info("Numbers of Products in lifestyle category="+products.size());
	Log.info("=====================================================================");
	
	Reporter.log("=====================================================================");
	Reporter.log("Numbers of Products in lifestyle category : ="+products.size());
	Reporter.log("=====================================================================");
