...
public class product_page_verifcation_men_category {
	
	
	private static Logger Log = Logger.getLogger(product_page_verifcation_men_category.class.getName());
	...
	public void productdetailvarification() throws InterruptedException, IOException,InvocationTargetException{
		...
		bis.product_attribute_verifiction("Men");
	}
