...
public class product_page_verifcation_bestseller_category {
	
	
	private static Logger Log = Logger.getLogger(product_page_verifcation_bestseller_category.class.getName());
	...
	public void product_attribute_verifiction() throws IOException, InterruptedException{
		...
		Log.info("=====================================================================");
		Log.info("Numbers of Products in bestseller category="+products.size());
		Log.info("=====================================================================");
		
		Reporter.log("=====================================================================");
		Reporter.log("Numbers of Products in bestseller category : ="+products.size());
		Reporter.log("=====================================================================");
