...
public class product_page_verifcation_electronics_category {
	
	
	private static Logger Log = Logger.getLogger(product_page_verifcation_electronics_category.class.getName());
	...
	public void productdetailvarification() throws InterruptedException, IOException,InvocationTargetException{
		...
		bis.click_on_category("Electronics");
		...
		bis.product_attribute_verifiction("Electronics");
	}	
}
